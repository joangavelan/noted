...
config :noted, NotedWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "Hn/TWepqoV8M4dOHV9w7Eea2lw1hf02VJTonl72/vdamqwGWM1j+05XV8OW18Pgu",
  watchers: [
...
config :noted, NotedWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"lib/noted_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :noted, dev_routes: true
